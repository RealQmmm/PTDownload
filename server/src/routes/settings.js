...
router.get('/export', (req, res) => {
    try {
        const db = getDB();
        const tables = ['sites', 'clients', 'tasks', 'rss_sources', 'settings', 'daily_stats', 'task_history', 'stats_checkpoint', 'site_daily_stats', 'users', 'series_subscriptions'];
        const data = {};
...
router.post('/import', async (req, res) => {
    ...
    try {
        const db = getDB();
        const tables = ['sites', 'clients', 'tasks', 'rss_sources', 'settings', 'daily_stats', 'task_history', 'task_logs', 'stats_checkpoint', 'site_daily_stats', 'users', 'series_subscriptions'];
